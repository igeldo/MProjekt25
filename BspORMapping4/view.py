...
class View:
    def __init__(self, root, model):
        ...
        # Label für die Blutgruppe
        self.blood_type_label = tk.Label(root, text="Blood Type:")
        self.blood_type_label.grid(row=3, column=0, padx=5, pady=5)

        # Variable für die ausgewählte Blutgruppe
        self.blood_type_var = tk.StringVar(value="A")  # Standardwert ist "A"

        # Frame, um die Radiobuttons eng zusammen zu platzieren
        self.blood_type_frame = tk.Frame(root)
        self.blood_type_frame.grid(row=3, column=1, padx=5, pady=5, sticky="W")

        # Radiobuttons für die Blutgruppe
        self.blood_type_a = tk.Radiobutton(self.blood_type_frame, text="A", variable=self.blood_type_var, value="A")
        self.blood_type_a.pack(side="left", padx=(45, 5))  # Erhöhe den linken Padding-Wert, z. B. 20

        self.blood_type_b = tk.Radiobutton(self.blood_type_frame, text="B", variable=self.blood_type_var, value="B")
        self.blood_type_b.pack(side="left", padx=5)        # Gleicher Abstand wie bisher

        self.blood_type_ab = tk.Radiobutton(self.blood_type_frame, text="AB", variable=self.blood_type_var, value="AB")
        self.blood_type_ab.pack(side="left", padx=5)
